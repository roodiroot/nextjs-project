...
const advantages: AdvantagesList[] = [
  {
    ...
    description: `Kóndish имеет в штате только сертифицированных специалистов, чьи знания и профессиональная компетенция подтверждены официальными документами.`,
