  ...
  return (
    ...
    >
      ...
      <div className='w-full text-xs text-slate-500'>
        ...
        и выполняется не только с оборудованием, приобретённым у нас. Мы сделаем
        более точный расчёт стоимости монтажа после консультации в нашем
        магазине. Пожалуйста, уточняйте стоимость и наличие услуг по телефону{" "}
